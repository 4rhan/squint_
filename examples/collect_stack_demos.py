...
Usage:
    python examples/collect_stack_demos.py -n 200 --only-count-success
    python examples/collect_stack_demos.py -n 1 --vis --save-video  # sanity check
"""
import argparse
...
def main(args):
    ...
    env = RecordEpisode(
        ...
        source_desc="scripted SO101 stack_cube motion-planning solution",
        video_fps=30,
        record_reward=False,
        save_on_reset=False,
    )
