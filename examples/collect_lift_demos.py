"""Collect scripted/motion-planning demonstrations for SO101LiftCube-v1.
...
`python -m mani_skill.trajectory.replay_trajectory`, e.g.:
    ...
    python -m mani_skill.trajectory.replay_trajectory \\
        --traj-path demos/SO101LiftCube-v1/motionplanning/trajectory.h5 \\
...
import envs  # noqa: F401  registers SO101LiftCube-v1 etc.
import gymnasium as gym
import numpy as np
from tqdm import tqdm

from examples.motionplanning.so101.solutions.lift_cube import solve
from mani_skill.utils.wrappers.record import RecordEpisode


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("-e", "--env-id", type=str, default="SO101LiftCube-v1")
